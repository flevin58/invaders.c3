; ModuleID = 'std_hash_siphash$ulong$2$4$'
source_filename = "std_hash_siphash$ulong$2$4$"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-apple-macosx11.0.0"

%.introspect.640 = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }
%"char[].639" = type { ptr, i64 }
%SipHash = type { [4 x i64], i64, i32, i64 }

@"$ct.std_hash_siphash$ulong$2$4$.SipHash" = linkonce global %.introspect.640 { i8 10, i64 0, ptr null, i64 56, i64 0, i64 4, [0 x i64] zeroinitializer }, align 8
@"std_hash_siphash$ulong$2$4$.BLOCK_ROUNDS" = weak local_unnamed_addr constant i32 2, align 4, !dbg !0
@"std_hash_siphash$ulong$2$4$.FINALIZE_ROUNDS" = weak local_unnamed_addr constant i32 4, align 4, !dbg !4

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_siphash$ulong$2$4$.SipHash.init"(ptr %0, i128 %1) #0 !dbg !14 {
entry:
...
; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %0, [2 x i64] %1) #0 !dbg !55 {
entry:
  %data = alloca %"char[].639", align 8
...
if.exit:                                          ; preds = %loop.body
  ...
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !87
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !87
...
; Function Attrs: nounwind uwtable(sync)
define weak i64 @"std_hash_siphash$ulong$2$4$.SipHash.final"(ptr %0) #0 !dbg !93 {
entry:
  %last = alloca [8 x i8], align 1
  %taddr = alloca %"char[].639", align 8
...
cond.phi:                                         ; preds = %cond.rhs, %cond.lhs
  ...
  %4 = insertvalue %"char[].639" undef, ptr %ptradd11, 0, !dbg !108
  %5 = insertvalue %"char[].639" %4, i64 %size, 1, !dbg !108
  store %"char[].639" %5, ptr %taddr, align 8
  %6 = load [2 x i64], ptr %taddr, align 8
  call void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %0, [2 x i64] %6), !dbg !109
  ...
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !112
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !112
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !112
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0), !dbg !112
...
; Function Attrs: nounwind uwtable(sync)
define internal void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0) #0 !dbg !118 {
entry:
...
; Function Attrs: nounwind uwtable(sync)
define weak i64 @"std_hash_siphash$ulong$2$4$.hash"([2 x i64] %0, i128 %1) #0 !dbg !190 {
entry:
  %data = alloca %"char[].639", align 8
  %s = alloca %SipHash, align 8
  store [2 x i64] %0, ptr %data, align 8
    #dbg_declare(ptr %data, !195, !DIExpression(), !196)
    #dbg_value(i128 %1, !197, !DIExpression(), !198)
    #dbg_declare(ptr %s, !194, !DIExpression(), !199)
  call void @llvm.memset.p0.i64(ptr align 8 %s, i8 0, i64 56, i1 false), !dbg !199
  call void @"std_hash_siphash$ulong$2$4$.SipHash.init"(ptr %s, i128 %1), !dbg !200
  %2 = load [2 x i64], ptr %data, align 8, !dbg !201
  call void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %s, [2 x i64] %2), !dbg !202
  %3 = call i64 @"std_hash_siphash$ulong$2$4$.SipHash.final"(ptr %s), !dbg !203
  ret i64 %3, !dbg !203
}
...
!1 = distinct !DIGlobalVariable(name: "BLOCK_ROUNDS", linkageName: "std_hash_siphash$ulong$2$4$.BLOCK_ROUNDS", scope: !2, file: !2, line: 11, type: !3, isLocal: false, isDefinition: true, align: 4)
!2 = !DIFile(filename: "siphash.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.7/lib/c3/std/hash")
!3 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!4 = !DIGlobalVariableExpression(var: !5, expr: !DIExpression())
!5 = distinct !DIGlobalVariable(name: "FINALIZE_ROUNDS", linkageName: "std_hash_siphash$ulong$2$4$.FINALIZE_ROUNDS", scope: !2, file: !2, line: 11, type: !3, isLocal: false, isDefinition: true, align: 4)
...
!13 = !{!0, !4}
!14 = distinct !DISubprogram(name: "init", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.init", scope: !2, file: !2, line: 70, type: !15, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !31)
!15 = !DISubroutineType(types: !16)
!16 = !{null, !17, !30}
!17 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "SipHash*", baseType: !18, size: 64, align: 64, dwarfAddressSpace: 0)
!18 = !DICompositeType(tag: DW_TAG_structure_type, name: "SipHash", scope: !2, file: !2, line: 54, size: 448, align: 64, elements: !19, identifier: "std_hash_siphash$ulong$2$4$.SipHash")
!19 = !{!20, !25, !27, !28}
...
!55 = distinct !DISubprogram(name: "update", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.update", scope: !2, file: !2, line: 89, type: !56, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !64)
...
!93 = distinct !DISubprogram(name: "final", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.final", scope: !2, file: !2, line: 113, type: !94, scopeLine: 113, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !97)
!94 = !DISubroutineType(types: !95)
!95 = !{!96, !17}
!96 = !DIDerivedType(tag: DW_TAG_typedef, name: "OutType", scope: !2, file: !2, line: 11, baseType: !22, align: 8)
!97 = !{!98}
...
!118 = distinct !DISubprogram(name: "round", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.round", scope: !2, file: !2, line: 145, type: !119, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !121)
...
!190 = distinct !DISubprogram(name: "hash", linkageName: "std_hash_siphash$ulong$2$4$.hash", scope: !2, file: !2, line: 62, type: !191, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !193)
!191 = !DISubroutineType(types: !192)
!192 = !{!96, !58, !30}
!193 = !{!194}
!194 = !DILocalVariable(name: "s", scope: !190, file: !2, line: 64, type: !18, align: 8)
!195 = !DILocalVariable(name: "data", arg: 1, scope: !190, file: !2, line: 62, type: !58)
!196 = !DILocation(line: 62, column: 24, scope: !190)
!197 = !DILocalVariable(name: "key", arg: 2, scope: !190, file: !2, line: 62, type: !30)
!198 = !DILocation(line: 62, column: 38, scope: !190)
!199 = !DILocation(line: 64, column: 10, scope: !190)
!200 = !DILocation(line: 65, column: 2, scope: !190)
!201 = !DILocation(line: 66, column: 11, scope: !190)
!202 = !DILocation(line: 66, column: 2, scope: !190)
!203 = !DILocation(line: 67, column: 9, scope: !190)
