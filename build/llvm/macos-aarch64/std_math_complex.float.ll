...
%.introspect.683 = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }
%ComplexNumber = type { %.anon.685 }
%.anon.685 = type { float, float }
%any.686 = type { ptr, i64 }
%"char[].682" = type { ptr, i64 }
%"any[].687" = type { ptr, i64 }

@"$ct.std_math_complex$float$.ComplexNumber.$anon" = linkonce global %.introspect.683 { i8 10, i64 0, ptr null, i64 8, i64 0, i64 2, [0 x i64] zeroinitializer }, align 8
@"$ct.std_math_complex$float$.ComplexNumber" = linkonce global %.introspect.683 { i8 11, i64 0, ptr null, i64 8, i64 0, i64 2, [0 x i64] zeroinitializer }, align 8
@"std_math_complex$float$.IDENTITY" = weak local_unnamed_addr constant %ComplexNumber { %.anon.685 { float 1.000000e+00, float 0.000000e+00 } }, align 4, !dbg !0
@"std_math_complex$float$.IMAGINARY" = weak local_unnamed_addr constant %ComplexNumber { %.anon.685 { float 0.000000e+00, float 1.000000e+00 } }, align 4, !dbg !16
@.str = private unnamed_addr constant [7 x i8] c"%g%+gi\00", align 1
@"$ct.float" = linkonce global %.introspect.683 { i8 4, i64 0, ptr null, i64 4, i64 0, i64 0, [0 x i64] zeroinitializer }, align 8
@"$sel.to_format" = linkonce_odr constant [10 x i8] c"to_format\00", align 1
@"$c3_dynamic" = internal global [1 x { ptr, ptr, i64 }] [{ ptr, ptr, i64 } { ptr @"std_math_complex$float$.ComplexNumber.to_format", ptr @"$sel.to_format", i64 ptrtoint (ptr @"$ct.std_math_complex$float$.ComplexNumber" to i64) }], section "__DATA,__c3_dynamic", no_sanitize_address, align 8
...
define weak i64 @"std_math_complex$float$.ComplexNumber.to_format"(ptr %0, ptr %1, ptr %2) #0 !dbg !26 {
entry:
  %reterr = alloca i64, align 8
  %varargslots = alloca [2 x %any.686], align 8
  %retparam = alloca i64, align 8
  %taddr = alloca %"char[].682", align 8
  %taddr2 = alloca %"any[].687", align 8
    #dbg_value(ptr %1, !53, !DIExpression(), !54)
    #dbg_value(ptr %2, !55, !DIExpression(), !56)
  %3 = insertvalue %any.686 undef, ptr %1, 0, !dbg !57
  %4 = insertvalue %any.686 %3, i64 ptrtoint (ptr @"$ct.float" to i64), 1, !dbg !57
  store %any.686 %4, ptr %varargslots, align 8, !dbg !57
  %ptradd = getelementptr inbounds i8, ptr %1, i64 4, !dbg !58
  %5 = insertvalue %any.686 undef, ptr %ptradd, 0, !dbg !58
  %6 = insertvalue %any.686 %5, i64 ptrtoint (ptr @"$ct.float" to i64), 1, !dbg !58
  %ptradd1 = getelementptr inbounds i8, ptr %varargslots, i64 16, !dbg !58
  store %any.686 %6, ptr %ptradd1, align 8, !dbg !58
  %7 = insertvalue %"any[].687" undef, ptr %varargslots, 0, !dbg !58
  %"$$temp" = insertvalue %"any[].687" %7, i64 2, 1, !dbg !58
  store %"char[].682" { ptr @.str, i64 6 }, ptr %taddr, align 8
  %8 = load [2 x i64], ptr %taddr, align 8
  store %"any[].687" %"$$temp", ptr %taddr2, align 8
...
!1 = distinct !DIGlobalVariable(name: "IDENTITY", linkageName: "std_math_complex$float$.IDENTITY", scope: !2, file: !2, line: 31, type: !3, isLocal: false, isDefinition: true, align: 4)
!2 = !DIFile(filename: "complex.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.7/lib/c3/std/math")
!3 = !DICompositeType(tag: DW_TAG_union_type, name: "ComplexNumber", scope: !2, file: !2, line: 22, size: 64, align: 32, elements: !4, identifier: "std_math_complex$float$.ComplexNumber")
!4 = !{!5, !12}
...
!17 = distinct !DIGlobalVariable(name: "IMAGINARY", linkageName: "std_math_complex$float$.IMAGINARY", scope: !2, file: !2, line: 32, type: !3, isLocal: false, isDefinition: true, align: 4)
...
!25 = !{!0, !16}
!26 = distinct !DISubprogram(name: "to_format", linkageName: "std_math_complex$float$.ComplexNumber.to_format", scope: !2, file: !2, line: 63, type: !27, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !52)
