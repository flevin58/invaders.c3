...
%.introspect.178 = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }

@"$ct.std.core.sanitizer.tsan.MutexFlags" = linkonce global %.introspect.178 { i8 18, i64 ptrtoint (ptr @"$ct.uint" to i64), ptr null, i64 4, i64 ptrtoint (ptr @"$ct.uint" to i64), i64 0, [0 x i64] zeroinitializer }, align 8
@"$ct.uint" = linkonce global %.introspect.178 { i8 3, i64 0, ptr null, i64 4, i64 0, i64 0, [0 x i64] zeroinitializer }, align 8
...
!2 = !DIFile(filename: "tsan.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.7/lib/c3/std/core/sanitizer")
