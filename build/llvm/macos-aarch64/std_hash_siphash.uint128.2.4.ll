; ModuleID = 'std_hash_siphash$uint128$2$4$'
source_filename = "std_hash_siphash$uint128$2$4$"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-apple-macosx11.0.0"

%.introspect.647 = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }
%"char[].646" = type { ptr, i64 }
%SipHash.649 = type { [4 x i64], i64, i32, i64 }

@"$ct.std_hash_siphash$uint128$2$4$.SipHash" = linkonce global %.introspect.647 { i8 10, i64 0, ptr null, i64 56, i64 0, i64 4, [0 x i64] zeroinitializer }, align 8
@"std_hash_siphash$uint128$2$4$.BLOCK_ROUNDS" = weak local_unnamed_addr constant i32 2, align 4, !dbg !0
@"std_hash_siphash$uint128$2$4$.FINALIZE_ROUNDS" = weak local_unnamed_addr constant i32 4, align 4, !dbg !4

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_siphash$uint128$2$4$.SipHash.init"(ptr %0, i128 %1) #0 !dbg !14 {
entry:
...
; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %0, [2 x i64] %1) #0 !dbg !56 {
entry:
  %data = alloca %"char[].646", align 8
...
if.exit:                                          ; preds = %loop.body
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !88
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !88
...
; Function Attrs: nounwind uwtable(sync)
define weak i128 @"std_hash_siphash$uint128$2$4$.SipHash.final"(ptr %0) #0 !dbg !94 {
entry:
  %last = alloca [8 x i8], align 1
  %taddr = alloca %"char[].646", align 8
...
cond.phi:                                         ; preds = %cond.rhs, %cond.lhs
  ...
  %4 = insertvalue %"char[].646" undef, ptr %ptradd11, 0, !dbg !110
  %5 = insertvalue %"char[].646" %4, i64 %size, 1, !dbg !110
  store %"char[].646" %5, ptr %taddr, align 8
  %6 = load [2 x i64], ptr %taddr, align 8
  call void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %0, [2 x i64] %6), !dbg !111
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !114
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !114
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !114
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !114
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !123
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !123
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !123
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0), !dbg !123
...
; Function Attrs: nounwind uwtable(sync)
define internal void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0) #0 !dbg !131 {
entry:
...
; Function Attrs: nounwind uwtable(sync)
define weak i128 @"std_hash_siphash$uint128$2$4$.hash"([2 x i64] %0, i128 %1) #0 !dbg !203 {
entry:
  %data = alloca %"char[].646", align 8
  %s = alloca %SipHash.649, align 8
  store [2 x i64] %0, ptr %data, align 8
    #dbg_declare(ptr %data, !208, !DIExpression(), !209)
    #dbg_value(i128 %1, !210, !DIExpression(), !211)
    #dbg_declare(ptr %s, !207, !DIExpression(), !212)
  call void @llvm.memset.p0.i64(ptr align 8 %s, i8 0, i64 56, i1 false), !dbg !212
  call void @"std_hash_siphash$uint128$2$4$.SipHash.init"(ptr %s, i128 %1), !dbg !213
  %2 = load [2 x i64], ptr %data, align 8, !dbg !214
  call void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %s, [2 x i64] %2), !dbg !215
  %3 = call i128 @"std_hash_siphash$uint128$2$4$.SipHash.final"(ptr %s), !dbg !216
  ret i128 %3, !dbg !216
}
...
!1 = distinct !DIGlobalVariable(name: "BLOCK_ROUNDS", linkageName: "std_hash_siphash$uint128$2$4$.BLOCK_ROUNDS", scope: !2, file: !2, line: 27, type: !3, isLocal: false, isDefinition: true, align: 4)
!2 = !DIFile(filename: "siphash.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.7/lib/c3/std/hash")
!3 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!4 = !DIGlobalVariableExpression(var: !5, expr: !DIExpression())
!5 = distinct !DIGlobalVariable(name: "FINALIZE_ROUNDS", linkageName: "std_hash_siphash$uint128$2$4$.FINALIZE_ROUNDS", scope: !2, file: !2, line: 27, type: !3, isLocal: false, isDefinition: true, align: 4)
...
!13 = !{!0, !4}
!14 = distinct !DISubprogram(name: "init", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.init", scope: !2, file: !2, line: 70, type: !15, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !31)
!15 = !DISubroutineType(types: !16)
!16 = !{null, !17, !30}
!17 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "SipHash*", baseType: !18, size: 64, align: 64, dwarfAddressSpace: 0)
!18 = !DICompositeType(tag: DW_TAG_structure_type, name: "SipHash", scope: !2, file: !2, line: 54, size: 448, align: 64, elements: !19, identifier: "std_hash_siphash$uint128$2$4$.SipHash")
!19 = !{!20, !25, !27, !28}
...
!56 = distinct !DISubprogram(name: "update", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.update", scope: !2, file: !2, line: 89, type: !57, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !65)
...
!94 = distinct !DISubprogram(name: "final", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.final", scope: !2, file: !2, line: 113, type: !95, scopeLine: 113, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !98)
!95 = !DISubroutineType(types: !96)
!96 = !{!97, !17}
!97 = !DIDerivedType(tag: DW_TAG_typedef, name: "OutType", scope: !2, file: !2, line: 27, baseType: !30, align: 16)
!98 = !{!99, !103}
...
!131 = distinct !DISubprogram(name: "round", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.round", scope: !2, file: !2, line: 145, type: !132, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !134)
...
!203 = distinct !DISubprogram(name: "hash", linkageName: "std_hash_siphash$uint128$2$4$.hash", scope: !2, file: !2, line: 62, type: !204, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !206)
!204 = !DISubroutineType(types: !205)
!205 = !{!97, !59, !30}
!206 = !{!207}
!207 = !DILocalVariable(name: "s", scope: !203, file: !2, line: 64, type: !18, align: 8)
!208 = !DILocalVariable(name: "data", arg: 1, scope: !203, file: !2, line: 62, type: !59)
!209 = !DILocation(line: 62, column: 24, scope: !203)
!210 = !DILocalVariable(name: "key", arg: 2, scope: !203, file: !2, line: 62, type: !30)
!211 = !DILocation(line: 62, column: 38, scope: !203)
!212 = !DILocation(line: 64, column: 10, scope: !203)
!213 = !DILocation(line: 65, column: 2, scope: !203)
!214 = !DILocation(line: 66, column: 11, scope: !203)
!215 = !DILocation(line: 66, column: 2, scope: !203)
!216 = !DILocation(line: 67, column: 9, scope: !203)
