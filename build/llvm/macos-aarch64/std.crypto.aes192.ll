; ModuleID = 'std::crypto::aes192'
source_filename = "std::crypto::aes192"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-apple-macosx11.0.0"

%any.81 = type { ptr, i64 }
%"char[].78" = type { ptr, i64 }
%Aes.82 = type { %AesKey.83, i32, [16 x i8], [256 x i8], [4 x [4 x i8]] }
%AesKey.83 = type { i64, i32, i32, i64, i64 }

@std.core.mem.allocator.current_temp = extern_weak thread_local global %any.81, align 8

; Function Attrs: nounwind uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.encrypt([2 x i64] %0, ptr %1, [2 x i64] %2, [2 x i64] %3) #0 !dbg !42 {
entry:
  %allocator = alloca %any.81, align 8
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[].78", align 8
  %aes = alloca %Aes.82, align 8
  %taddr = alloca %"char[].78", align 8
  %result = alloca %"char[].78", align 8
  %taddr1 = alloca %"char[].78", align 8
  ...
  %4 = insertvalue %"char[].78" undef, ptr %1, 0, !dbg !71
  %5 = insertvalue %"char[].78" %4, i64 24, 1, !dbg !71
  store %"char[].78" %5, ptr %taddr, align 8
  %6 = load [2 x i64], ptr %taddr, align 8
  %7 = load [2 x i64], ptr %iv, align 1
  %8 = call ptr @std.crypto.aes.Aes.init(ptr %aes, i32 1, [2 x i64] %6, [2 x i64] %7, i32 2), !dbg !72
  ...
  %12 = load %"char[].78", ptr %result, align 8
  call void @std.crypto.aes.Aes.destroy(ptr %aes), !dbg !75
  store %"char[].78" %12, ptr %taddr1, align 8
  %13 = load [2 x i64], ptr %taddr1, align 8
  ret [2 x i64] %13
}

; Function Attrs: nounwind uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.tencrypt(ptr %0, [2 x i64] %1, [2 x i64] %2) #0 !dbg !77 {
entry:
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[].78", align 8
  %result = alloca %"char[].78", align 8
  ...
  %7 = call [2 x i64] @std.crypto.aes192.encrypt([2 x i64] %4, ptr %0, [2 x i64] %5, [2 x i64] %6), !dbg !89
...
; Function Attrs: nounwind uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.decrypt([2 x i64] %0, ptr %1, [2 x i64] %2, [2 x i64] %3) #0 !dbg !90 {
entry:
  %allocator = alloca %any.81, align 8
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[].78", align 8
  ...
  %4 = insertvalue %"char[].78" undef, ptr %1, 0, !dbg !102
  %5 = insertvalue %"char[].78" %4, i64 24, 1, !dbg !102
  store %"char[].78" %5, ptr %taddr, align 8
  %6 = load [2 x i64], ptr %taddr, align 8
  %7 = load [2 x i64], ptr %iv, align 1
  %8 = call ptr @std.crypto.aes.Aes.init(ptr %aes, i32 1, [2 x i64] %6, [2 x i64] %7, i32 2), !dbg !103
...
; Function Attrs: nounwind uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.tdecrypt(ptr %0, [2 x i64] %1, [2 x i64] %2) #0 !dbg !108 {
entry:
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[].78", align 8
  %result = alloca %"char[].78", align 8
  ...
  %7 = call [2 x i64] @std.crypto.aes192.decrypt([2 x i64] %4, ptr %0, [2 x i64] %5, [2 x i64] %6), !dbg !117
  store [2 x i64] %7, ptr %result, align 8
  %8 = load [2 x i64], ptr %result, align 8
  ret [2 x i64] %8
}
...
!42 = distinct !DISubprogram(name: "encrypt", linkageName: "std.crypto.aes192.encrypt", scope: !7, file: !7, line: 34, type: !43, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !6, retainedNodes: !60)
...
!56 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "char[24]*", baseType: !57, size: 64, align: 64, dwarfAddressSpace: 0)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !26, size: 192, align: 8, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 24, lowerBound: 0)
!60 = !{!61}
!61 = !DILocalVariable(name: "aes", scope: !42, file: !7, line: 36, type: !10, align: 8)
!62 = !DILocalVariable(name: "allocator", arg: 1, scope: !42, file: !7, line: 34, type: !50)
!63 = !DILocation(line: 34, column: 29, scope: !42)
!64 = !DILocalVariable(name: "key", arg: 2, scope: !42, file: !7, line: 34, type: !56)
!65 = !DILocation(line: 34, column: 50, scope: !42)
!66 = !DILocalVariable(name: "iv", arg: 3, scope: !42, file: !7, line: 34, type: !25)
!67 = !DILocation(line: 34, column: 75, scope: !42)
!68 = !DILocalVariable(name: "data", arg: 4, scope: !42, file: !7, line: 34, type: !45)
!69 = !DILocation(line: 34, column: 86, scope: !42)
!70 = !DILocation(line: 36, column: 6, scope: !42)
!71 = !DILocation(line: 37, column: 19, scope: !42)
!72 = !DILocation(line: 37, column: 2, scope: !42)
!73 = !DILocation(line: 39, column: 32, scope: !42)
!74 = !DILocation(line: 39, column: 9, scope: !42)
!75 = !DILocation(line: 38, column: 8, scope: !76)
!76 = distinct !DILexicalBlock(scope: !42, file: !7, line: 38, column: 8)
!77 = distinct !DISubprogram(name: "tencrypt", linkageName: "std.crypto.aes192.tencrypt", scope: !7, file: !7, line: 42, type: !78, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !6, retainedNodes: !80)
!78 = !DISubroutineType(types: !79)
!79 = !{!45, !56, !25, !45}
!80 = !{}
!81 = !DILocalVariable(name: "key", arg: 1, scope: !77, file: !7, line: 42, type: !56)
!82 = !DILocation(line: 42, column: 30, scope: !77)
!83 = !DILocalVariable(name: "iv", arg: 2, scope: !77, file: !7, line: 42, type: !25)
!84 = !DILocation(line: 42, column: 55, scope: !77)
!85 = !DILocalVariable(name: "data", arg: 3, scope: !77, file: !7, line: 42, type: !45)
!86 = !DILocation(line: 42, column: 66, scope: !77)
!87 = !DILocation(line: 44, column: 17, scope: !77)
!88 = !DILocation(line: 44, column: 32, scope: !77)
!89 = !DILocation(line: 44, column: 9, scope: !77)
!90 = distinct !DISubprogram(name: "decrypt", linkageName: "std.crypto.aes192.decrypt", scope: !7, file: !7, line: 47, type: !43, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !6, retainedNodes: !91)
!91 = !{!92}
!92 = !DILocalVariable(name: "aes", scope: !90, file: !7, line: 49, type: !10, align: 8)
!93 = !DILocalVariable(name: "allocator", arg: 1, scope: !90, file: !7, line: 47, type: !50)
!94 = !DILocation(line: 47, column: 29, scope: !90)
!95 = !DILocalVariable(name: "key", arg: 2, scope: !90, file: !7, line: 47, type: !56)
!96 = !DILocation(line: 47, column: 50, scope: !90)
!97 = !DILocalVariable(name: "iv", arg: 3, scope: !90, file: !7, line: 47, type: !25)
!98 = !DILocation(line: 47, column: 75, scope: !90)
!99 = !DILocalVariable(name: "data", arg: 4, scope: !90, file: !7, line: 47, type: !45)
!100 = !DILocation(line: 47, column: 86, scope: !90)
!101 = !DILocation(line: 49, column: 6, scope: !90)
!102 = !DILocation(line: 50, column: 19, scope: !90)
!103 = !DILocation(line: 50, column: 2, scope: !90)
!104 = !DILocation(line: 52, column: 32, scope: !90)
!105 = !DILocation(line: 52, column: 9, scope: !90)
!106 = !DILocation(line: 51, column: 8, scope: !107)
!107 = distinct !DILexicalBlock(scope: !90, file: !7, line: 51, column: 8)
!108 = distinct !DISubprogram(name: "tdecrypt", linkageName: "std.crypto.aes192.tdecrypt", scope: !7, file: !7, line: 55, type: !78, scopeLine: 55, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !6, retainedNodes: !80)
!109 = !DILocalVariable(name: "key", arg: 1, scope: !108, file: !7, line: 55, type: !56)
!110 = !DILocation(line: 55, column: 30, scope: !108)
!111 = !DILocalVariable(name: "iv", arg: 2, scope: !108, file: !7, line: 55, type: !25)
!112 = !DILocation(line: 55, column: 55, scope: !108)
!113 = !DILocalVariable(name: "data", arg: 3, scope: !108, file: !7, line: 55, type: !45)
!114 = !DILocation(line: 55, column: 66, scope: !108)
!115 = !DILocation(line: 57, column: 17, scope: !108)
!116 = !DILocation(line: 57, column: 32, scope: !108)
