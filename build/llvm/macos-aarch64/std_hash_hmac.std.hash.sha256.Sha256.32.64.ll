...
%.introspect.660 = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }
%"char[].659" = type { ptr, i64 }
%Hmac.662 = type { %Sha256.663, %Sha256.663 }
%Sha256.663 = type { [8 x i32], i64, [64 x i8] }

@"$ct.std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac" = linkonce global %.introspect.660 { i8 10, i64 0, ptr null, i64 208, i64 0, i64 2, [0 x i64] zeroinitializer }, align 8
@"std_hash_hmac$std.hash.sha256.Sha256$32$64$.IPAD" = internal unnamed_addr constant i32 54, align 4, !dbg !0
@"std_hash_hmac$std.hash.sha256.Sha256$32$64$.OPAD" = internal unnamed_addr constant i32 92, align 4, !dbg !4
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %buffer, i8 0, i64 64, i1 false), !dbg !61
  %ptradd = getelementptr inbounds i8, ptr %key, i64 8, !dbg !62
  %2 = load i64, ptr %ptradd, align 8, !dbg !62
  %lt = icmp ult i64 64, %2, !dbg !62
  br i1 %lt, label %if.then, label %if.else, !dbg !62

if.then:                                          ; preds = %entry
  call void @std.hash.sha256.Sha256.init(ptr %0), !dbg !63
  %3 = load [2 x i64], ptr %key, align 8, !dbg !65
  call void @std.hash.sha256.Sha256.update(ptr %0, [2 x i64] %3), !dbg !66
  call void @std.hash.sha256.Sha256.final(ptr sret([32 x i8]) align 1 %sretparam, ptr %0), !dbg !67
  %4 = insertvalue %"char[].659" undef, ptr %sretparam, 0, !dbg !67
  %5 = insertvalue %"char[].659" %4, i64 32, 1, !dbg !67
  %6 = insertvalue %"char[].659" undef, ptr %buffer, 0, !dbg !68
  %7 = insertvalue %"char[].659" %6, i64 32, 1, !dbg !68
  %8 = extractvalue %"char[].659" %7, 0, !dbg !68
  %9 = extractvalue %"char[].659" %5, 0, !dbg !68
  %10 = extractvalue %"char[].659" %5, 1, !dbg !68
...
if.else:                                          ; preds = %entry
  %12 = load %"char[].659", ptr %key, align 8, !dbg !69
  %13 = extractvalue %"char[].659" %12, 0, !dbg !69
  %14 = extractvalue %"char[].659" %12, 1, !dbg !71
  %size = sub i64 %14, 0, !dbg !71
  %15 = insertvalue %"char[].659" undef, ptr %13, 0, !dbg !71
  %16 = insertvalue %"char[].659" %15, i64 %size, 1, !dbg !71
  ...
  %18 = insertvalue %"char[].659" undef, ptr %buffer, 0, !dbg !72
  %19 = insertvalue %"char[].659" %18, i64 %size2, 1, !dbg !72
  %20 = extractvalue %"char[].659" %19, 0, !dbg !72
  %21 = extractvalue %"char[].659" %16, 0, !dbg !72
  %22 = extractvalue %"char[].659" %16, 1, !dbg !72
...
loop.exit:                                        ; preds = %loop.cond
  call void @std.hash.sha256.Sha256.init(ptr %0), !dbg !78
  %29 = insertvalue %"char[].659" undef, ptr %buffer, 0, !dbg !79
  %30 = insertvalue %"char[].659" %29, i64 64, 1, !dbg !79
  store %"char[].659" %30, ptr %taddr, align 8
  %31 = load [2 x i64], ptr %taddr, align 8
  call void @std.hash.sha256.Sha256.update(ptr %0, [2 x i64] %31), !dbg !80
...
loop.exit12:                                      ; preds = %loop.cond5
  %ptradd13 = getelementptr inbounds i8, ptr %0, i64 104, !dbg !86
  call void @std.hash.sha256.Sha256.init(ptr %ptradd13), !dbg !86
  %ptradd14 = getelementptr inbounds i8, ptr %0, i64 104, !dbg !87
  %37 = insertvalue %"char[].659" undef, ptr %buffer, 0, !dbg !88
  %38 = insertvalue %"char[].659" %37, i64 64, 1, !dbg !88
  store %"char[].659" %38, ptr %taddr15, align 8
  %39 = load [2 x i64], ptr %taddr15, align 8
  call void @std.hash.sha256.Sha256.update(ptr %ptradd14, [2 x i64] %39), !dbg !87
  %40 = insertvalue %"char[].659" undef, ptr %buffer, 0, !dbg !89
  %41 = insertvalue %"char[].659" %40, i64 64, 1, !dbg !89
  %42 = extractvalue %"char[].659" %41, 0, !dbg !90
  %43 = extractvalue %"char[].659" %41, 1, !dbg !94
  call void @llvm.memset.p0.i64(ptr align 1 %42, i8 0, i64 %43, i1 true), !dbg !95
  ret void, !dbg !95
}

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %0, [2 x i64] %1) #0 !dbg !96 {
entry:
  %data = alloca %"char[].659", align 8
  ...
  call void @std.hash.sha256.Sha256.update(ptr %0, [2 x i64] %2), !dbg !103
  ret void, !dbg !103
}

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr noalias sret([32 x i8]) align 1 %0, ptr %1) #0 !dbg !104 {
entry:
  %sretparam = alloca [32 x i8], align 1
  %taddr = alloca %"char[].659", align 8
  %sretparam2 = alloca [32 x i8], align 1
    #dbg_value(ptr %1, !110, !DIExpression(), !111)
  %ptradd = getelementptr inbounds i8, ptr %1, i64 104, !dbg !112
  call void @std.hash.sha256.Sha256.final(ptr sret([32 x i8]) align 1 %sretparam, ptr %1), !dbg !113
  %2 = insertvalue %"char[].659" undef, ptr %sretparam, 0, !dbg !113
  %3 = insertvalue %"char[].659" %2, i64 32, 1, !dbg !113
  store %"char[].659" %3, ptr %taddr, align 8
  %4 = load [2 x i64], ptr %taddr, align 8
  call void @std.hash.sha256.Sha256.update(ptr %ptradd, [2 x i64] %4), !dbg !112
  %ptradd1 = getelementptr inbounds i8, ptr %1, i64 104, !dbg !114
  call void @std.hash.sha256.Sha256.final(ptr sret([32 x i8]) align 1 %sretparam2, ptr %ptradd1), !dbg !114
  call void @llvm.memcpy.p0.p0.i32(ptr align 1 %0, ptr align 1 %sretparam2, i32 32, i1 false), !dbg !114
  ret void, !dbg !114
}

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.hash"(ptr noalias sret([32 x i8]) align 1 %0, [2 x i64] %1, [2 x i64] %2) #0 !dbg !115 {
entry:
  %key = alloca %"char[].659", align 8
  %message = alloca %"char[].659", align 8
  %hmac = alloca %Hmac.662, align 8
  %sretparam = alloca [32 x i8], align 1
  store [2 x i64] %1, ptr %key, align 8
  ...
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.init"(ptr %hmac, [2 x i64] %3), !dbg !126
  %4 = load [2 x i64], ptr %message, align 8, !dbg !127
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac, [2 x i64] %4), !dbg !128
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr sret([32 x i8]) align 1 %sretparam, ptr %hmac), !dbg !129
  call void @llvm.memcpy.p0.p0.i32(ptr align 1 %0, ptr align 1 %sretparam, i32 32, i1 false), !dbg !129
  ret void, !dbg !129
}

; Function Attrs: nounwind uwtable(sync)
define weak void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.pbkdf2"([2 x i64] %0, [2 x i64] %1, i32 %2, [2 x i64] %3) #0 !dbg !130 {
entry:
  %pw = alloca %"char[].659", align 8
  %salt = alloca %"char[].659", align 8
  %output = alloca %"char[].659", align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  %hmac = alloca %Hmac.662, align 8
  %dst_curr = alloca %"char[].659", align 8
  %i = alloca i64, align 8
  %salt4 = alloca %"char[].659", align 8
  %index = alloca i64, align 8
  %out = alloca %"char[].659", align 8
  %tmp = alloca [32 x i8], align 1
  %hmac6 = alloca %Hmac.662, align 8
  %be = alloca i32, align 4
  %expr = alloca i32, align 4
  %taddr = alloca %"char[].659", align 8
  %it = alloca i32, align 4
  %taddr10 = alloca %"char[].659", align 8
  %.anon = alloca i64, align 8
  %i14 = alloca i64, align 8
  %v = alloca i8, align 1
  %tmp23 = alloca [32 x i8], align 1
  %salt24 = alloca %"char[].659", align 8
  %out26 = alloca %"char[].659", align 8
  %tmp29 = alloca [32 x i8], align 1
  %hmac30 = alloca %Hmac.662, align 8
  %be31 = alloca i32, align 4
  %expr33 = alloca i32, align 4
  %taddr34 = alloca %"char[].659", align 8
  %it36 = alloca i32, align 4
  %taddr42 = alloca %"char[].659", align 8
  ...
  %gt = icmp ugt i64 67108863, %5, !dbg !152
  ...
  %smod = srem i64 %7, 32, !dbg !156
  store i64 %smod, ptr %r, align 8, !dbg !156
    #dbg_declare(ptr %hmac, !136, !DIExpression(), !157)
  call void @llvm.memset.p0.i64(ptr align 8 %hmac, i8 0, i64 208, i1 false), !dbg !157
  %8 = load [2 x i64], ptr %pw, align 8, !dbg !158
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.init"(ptr %hmac, [2 x i64] %8), !dbg !159
...
loop.body:                                        ; preds = %loop.cond
  ...
  %12 = load %"char[].659", ptr %dst_curr, align 8, !dbg !166
  %13 = extractvalue %"char[].659" %12, 0, !dbg !166
  %14 = insertvalue %"char[].659" undef, ptr %13, 0, !dbg !166
  %15 = insertvalue %"char[].659" %14, i64 32, 1, !dbg !166
  store %"char[].659" %15, ptr %out, align 8
  %ptradd5 = getelementptr inbounds i8, ptr %out, i64 8, !dbg !168
  %16 = load i64, ptr %ptradd5, align 8, !dbg !168
  %eq = icmp eq i64 32, %16, !dbg !168
  call void @llvm.assume(i1 %eq), !dbg !168
    #dbg_declare(ptr %tmp, !171, !DIExpression(), !183)
    #dbg_declare(ptr %hmac6, !172, !DIExpression(), !184)
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %hmac6, ptr align 8 %hmac, i32 208, i1 false), !dbg !185
  %17 = load [2 x i64], ptr %salt4, align 8, !dbg !186
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac6, [2 x i64] %17), !dbg !187
  ...
  %22 = insertvalue %"char[].659" undef, ptr %expr, 0, !dbg !190
  %23 = insertvalue %"char[].659" %22, i64 4, 1, !dbg !190
  store %"char[].659" %23, ptr %taddr, align 8
  %24 = load [2 x i64], ptr %taddr, align 8
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac6, [2 x i64] %24), !dbg !194
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr sret([32 x i8]) align 1 %tmp, ptr %hmac6), !dbg !195
  %25 = insertvalue %"char[].659" undef, ptr %tmp, 0, !dbg !196
  %26 = insertvalue %"char[].659" %25, i64 32, 1, !dbg !196
  %27 = load %"char[].659", ptr %out, align 8, !dbg !197
  %28 = extractvalue %"char[].659" %27, 0, !dbg !197
  %29 = extractvalue %"char[].659" %27, 1, !dbg !198
  %size = sub i64 %29, 0, !dbg !198
  %30 = insertvalue %"char[].659" undef, ptr %28, 0, !dbg !198
  %31 = insertvalue %"char[].659" %30, i64 %size, 1, !dbg !198
  %32 = extractvalue %"char[].659" %31, 0, !dbg !198
  %33 = extractvalue %"char[].659" %26, 0, !dbg !198
  %34 = extractvalue %"char[].659" %26, 1, !dbg !198
...
loop.body9:                                       ; preds = %loop.cond7
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %hmac6, ptr align 8 %hmac, i32 208, i1 false), !dbg !202
  %37 = insertvalue %"char[].659" undef, ptr %tmp, 0, !dbg !203
  %38 = insertvalue %"char[].659" %37, i64 32, 1, !dbg !203
  store %"char[].659" %38, ptr %taddr10, align 8
  %39 = load [2 x i64], ptr %taddr10, align 8
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac6, [2 x i64] %39), !dbg !204
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr sret([32 x i8]) align 1 %tmp, ptr %hmac6), !dbg !205
...
loop.cond11:                                      ; preds = %loop.body13, %loop.body9
  ...
  %gt12 = icmp ugt i64 32, %40, !dbg !206
...
loop.exit17:                                      ; preds = %loop.cond7
  %50 = insertvalue %"char[].659" undef, ptr %tmp, 0, !dbg !214
  %51 = insertvalue %"char[].659" %50, i64 32, 1, !dbg !214
  %52 = extractvalue %"char[].659" %51, 0, !dbg !216
  %53 = extractvalue %"char[].659" %51, 1, !dbg !219
  call void @llvm.memset.p0.i64(ptr align 1 %52, i8 0, i64 %53, i1 true), !dbg !220
  %54 = load %"char[].659", ptr %dst_curr, align 8, !dbg !221
  %55 = extractvalue %"char[].659" %54, 0, !dbg !221
  %56 = extractvalue %"char[].659" %54, 1, !dbg !222
  %size18 = sub i64 %56, 32, !dbg !222
  %ptradd19 = getelementptr inbounds i8, ptr %55, i64 32, !dbg !222
  %57 = insertvalue %"char[].659" undef, ptr %ptradd19, 0, !dbg !222
  %58 = insertvalue %"char[].659" %57, i64 %size18, 1, !dbg !222
  store %"char[].659" %58, ptr %dst_curr, align 8, !dbg !222
...
if.then:                                          ; preds = %loop.exit21
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %tmp23, i8 0, i64 32, i1 false), !dbg !225
  ...
  %62 = insertvalue %"char[].659" undef, ptr %tmp23, 0, !dbg !227
  %63 = insertvalue %"char[].659" %62, i64 32, 1, !dbg !227
  store %"char[].659" %63, ptr %out26, align 8
  %ptradd27 = getelementptr inbounds i8, ptr %out26, i64 8, !dbg !228
  %64 = load i64, ptr %ptradd27, align 8, !dbg !228
  %eq28 = icmp eq i64 32, %64, !dbg !228
  ...
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %hmac30, ptr align 8 %hmac, i32 208, i1 false), !dbg !245
  %65 = load [2 x i64], ptr %salt24, align 8, !dbg !246
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac30, [2 x i64] %65), !dbg !247
  ...
  %69 = insertvalue %"char[].659" undef, ptr %expr33, 0, !dbg !250
  %70 = insertvalue %"char[].659" %69, i64 4, 1, !dbg !250
  store %"char[].659" %70, ptr %taddr34, align 8
  %71 = load [2 x i64], ptr %taddr34, align 8
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac30, [2 x i64] %71), !dbg !253
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr sret([32 x i8]) align 1 %tmp29, ptr %hmac30), !dbg !254
  %72 = insertvalue %"char[].659" undef, ptr %tmp29, 0, !dbg !255
  %73 = insertvalue %"char[].659" %72, i64 32, 1, !dbg !255
  %74 = load %"char[].659", ptr %out26, align 8, !dbg !256
  %75 = extractvalue %"char[].659" %74, 0, !dbg !256
  %76 = extractvalue %"char[].659" %74, 1, !dbg !257
  %size35 = sub i64 %76, 0, !dbg !257
  %77 = insertvalue %"char[].659" undef, ptr %75, 0, !dbg !257
  %78 = insertvalue %"char[].659" %77, i64 %size35, 1, !dbg !257
  %79 = extractvalue %"char[].659" %78, 0, !dbg !257
  %80 = extractvalue %"char[].659" %73, 0, !dbg !257
  %81 = extractvalue %"char[].659" %73, 1, !dbg !257
...
loop.body41:                                      ; preds = %loop.cond37
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %hmac30, ptr align 8 %hmac, i32 208, i1 false), !dbg !261
  %84 = insertvalue %"char[].659" undef, ptr %tmp29, 0, !dbg !262
  %85 = insertvalue %"char[].659" %84, i64 32, 1, !dbg !262
  store %"char[].659" %85, ptr %taddr42, align 8
  %86 = load [2 x i64], ptr %taddr42, align 8
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update"(ptr %hmac30, [2 x i64] %86), !dbg !263
  call void @"std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final"(ptr sret([32 x i8]) align 1 %tmp29, ptr %hmac30), !dbg !264
...
loop.cond44:                                      ; preds = %loop.body46, %loop.body41
  ...
  %gt45 = icmp ugt i64 32, %87, !dbg !265
...
loop.exit55:                                      ; preds = %loop.cond37
  %97 = insertvalue %"char[].659" undef, ptr %tmp29, 0, !dbg !273
  %98 = insertvalue %"char[].659" %97, i64 32, 1, !dbg !273
  %99 = extractvalue %"char[].659" %98, 0, !dbg !275
  %100 = extractvalue %"char[].659" %98, 1, !dbg !278
  ...
  %102 = insertvalue %"char[].659" undef, ptr %tmp23, 0, !dbg !280
  %103 = insertvalue %"char[].659" %102, i64 %size58, 1, !dbg !280
  %104 = load %"char[].659", ptr %dst_curr, align 8, !dbg !281
  %105 = extractvalue %"char[].659" %104, 0, !dbg !281
  %106 = extractvalue %"char[].659" %104, 1, !dbg !282
  %size59 = sub i64 %106, 0, !dbg !282
  %107 = insertvalue %"char[].659" undef, ptr %105, 0, !dbg !282
  %108 = insertvalue %"char[].659" %107, i64 %size59, 1, !dbg !282
  %109 = extractvalue %"char[].659" %108, 0, !dbg !282
  %110 = extractvalue %"char[].659" %103, 0, !dbg !282
  %111 = extractvalue %"char[].659" %103, 1, !dbg !282
  %112 = mul i64 %111, 1, !dbg !282
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %109, ptr align 1 %110, i64 %112, i1 false), !dbg !282
  %113 = insertvalue %"char[].659" undef, ptr %tmp23, 0, !dbg !283
  %114 = insertvalue %"char[].659" %113, i64 32, 1, !dbg !283
  %115 = extractvalue %"char[].659" %114, 0, !dbg !284
  %116 = extractvalue %"char[].659" %114, 1, !dbg !287
...
!1 = distinct !DIGlobalVariable(name: "IPAD", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.IPAD", scope: !2, file: !2, line: 83, type: !3, isLocal: true, isDefinition: true, align: 4)
!2 = !DIFile(filename: "hmac.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.7/lib/c3/std/hash")
!3 = !DIBasicType(name: "uint", size: 32, encoding: DW_ATE_unsigned)
!4 = !DIGlobalVariableExpression(var: !5, expr: !DIExpression())
!5 = distinct !DIGlobalVariable(name: "OPAD", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.OPAD", scope: !2, file: !2, line: 84, type: !3, isLocal: true, isDefinition: true, align: 4)
...
!18 = !{!0, !4, !6, !9}
!19 = distinct !DISubprogram(name: "init", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.init", scope: !2, file: !2, line: 45, type: !20, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !47)
...
!30 = !DICompositeType(tag: DW_TAG_array_type, baseType: !3, size: 256, align: 32, elements: !31)
!31 = !{!32}
!32 = !DISubrange(count: 8, lowerBound: 0)
!33 = !DIDerivedType(tag: DW_TAG_member, name: "bitcount", scope: !27, file: !2, line: 33, baseType: !34, size: 64, align: 64, offset: 256)
!34 = !DIBasicType(name: "ulong", size: 64, encoding: DW_ATE_unsigned)
!35 = !DIDerivedType(tag: DW_TAG_member, name: "buffer", scope: !27, file: !2, line: 34, baseType: !36, size: 512, align: 8, offset: 320)
...
!46 = !DIDerivedType(tag: DW_TAG_typedef, name: "usz", baseType: !34)
!47 = !{!48, !49, !51, !53, !55}
...
!96 = distinct !DISubprogram(name: "update", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.update", scope: !2, file: !2, line: 72, type: !20, scopeLine: 72, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !97)
!97 = !{}
...
!104 = distinct !DISubprogram(name: "final", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.Hmac.final", scope: !2, file: !2, line: 77, type: !105, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !97)
!105 = !DISubroutineType(types: !106)
!106 = !{!107, !22}
!107 = !DICompositeType(tag: DW_TAG_array_type, baseType: !37, size: 256, align: 8, elements: !108)
!108 = !{!109}
!109 = !DISubrange(count: 32, lowerBound: 0)
...
!115 = distinct !DISubprogram(name: "hash", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.hash", scope: !2, file: !2, line: 9, type: !116, scopeLine: 9, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !118)
...
!130 = distinct !DISubprogram(name: "pbkdf2", linkageName: "std_hash_hmac$std.hash.sha256.Sha256$32$64$.pbkdf2", scope: !2, file: !2, line: 21, type: !131, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !133)
